...
<div id="multi-item-example" class="carousel slide carousel-multi-item carousel-multi-item-2" data-ride="carousel">
    <div >
        <h2 class="headline float-left mt-5">Best Selling</h2>
    </div>
 ...
 @foreach ($best_selling->take(4) as $food)
...
<div id="multi-item-example" class="carousel slide carousel-multi-item carousel-multi-item-2" data-ride="carousel">
    <div>
        <h2 class="headline float-left mt-5">Food</h2>
    </div>
...
#result,#resultBMR{
    ...
    font-weight: bold;
    font-size: 20px;
}#warningBMI,#warningBMR,#warningMacro{
    margin-top: 13px;
    margin-bottom: 0rem;
    font-weight: bold;
    font-size: 20px;
...
<!----------BMI---------->
  ...
  <div class="tab">
    ...
    <div class="row">
           <div class="col-md-6">
            <input type="number" step="any" min="0" name="foot" id="foot" class="calculatorShortInput" placeholder="Foot" onfocus="this.placeholder = ''"  oninput="this.value = Math.abs(this.value)"  onchange="ageFunction(this.value);" oninput ="ageFunction(this.value);">
    ...
    <div class="col-md-6">
        <input type="number" step="any" min="0" name="inch" id="inch" class="calculatorShortInput" placeholder="Inch" onfocus="this.placeholder = ''"  oninput="this.value = Math.abs(this.value)">
    ...
    <input  style="width: 83% !important;margin-left: -23px;" type="number" step="any" min="0" name="weight" id="weight" class="calculatorShortInput" placeholder="Enter Your weight" onfocus="this.placeholder = ''"  oninput="this.value = Math.abs(this.value)">
...
<!----------BMR---------->
  ...
  <div class="tab">
    ...
    <input type="number" step="any" min="0" name="age" id="age" class="calculatorMedInput" value="" required="" oninput="this.value = Math.abs(this.value)" style="width:84%;margin-left:17px"  onchange="ageFunction(this.value);" oninput ="ageFunction(this.value);" value="">
    <span class="clearElement"></span>
    </div>
...
<br>
    <div class="single-field">
    <label for="bmrFormula" class="">Goal</label>
    ...
    <span class="clearElement"></span>
     ...
     <div class="single-field mt-2">
    <!-- <label for="bmrFormula" class=""></label> -->
    <select name="medical_term" id="medical_term">
    <option value="6">Select Your Medical Term (If Any)</option>
    <option value="1">I have Diabetes </option>
    ...
    <option value="5">I have No Disease</option>
    </select>
    <span class="clearElement"></span>
    </div>
...
<div class="float-right mt-5 mr-5" style=" margin-right: 110px !important;">
  ...
  style="position: fixed;z-index: 1;bottom: 0px;border-radius: 50%;padding: 40px 0 42px 0px;;text-align: center;font-size: 14px;background: cadetblue;color: white !important;border: 1px solid;text-decoration: none;font-weight: 800;">
...
if (f != "" || f !=0) {
  ...
  document.getElementById("warningBMI").innerHTML="*Weight can't be 0 or empty"
}
}else{
  document.getElementById("warningBMI").innerHTML="*Inch can't be 0 or empty"
}
}else{
  document.getElementById("warningBMI").innerHTML="*Foot can't be 0 or empty"
}
  }
  ...
  if (bmrFormula==0) {
   document.getElementById("warningBMR").innerHTML="*Plese select an activity";
  }else if (age == "" || age == 0) {
  ...
  for (i = 0; i < y.length; i++) {
    ...
    document.getElementById("warningBMR").innerHTML="*Age can't be 0 or empty"
  }else{
  ...
  document.getElementById("warningBMR").style.visibility="hidden";
  }
    }
  }
  ...
  for (i = 0; i < y.length; i++) {
    ...
    if (y[i].value == "") {
      // add an "invalid" class to the field:
      y[i].className += " invalid";
      document.getElementById("warningMacro").innerHTML="*Body fat can't be 0 or empty"
      // and set the current valid status to false
      valid = false;
    }else{
      y[i].className += " valid";
  ...
  document.getElementById("warningMacro").innerHTML="*Plese input correct body fat";
}
...
if (f != "" || f > 0) {
  ...
  // console.log(f , i, w);
  var bmi = (weightLbs / Math.pow(h, 2)) * 703;
  document.getElementById("warningBMI").style.visibility="hidden";
      document.getElementById("result").innerHTML="Your BMI is : "+bmi.toFixed(2);
}else{
...
function Macro(){
  ...
  var body_fat = document.getElementById("body_fat").value;
  var goal = document.getElementById("gol").value;
  gop = document.getElementById("protein").value;
  var gof = document.getElementById("fat").value;
  var medical_term = document.getElementById("medical_term").value;
  ...
  document.getElementById("warningMacro").style.visibility="hidden";
  document.getElementById("resultMacro").innerHTML="Protein: "+protein.toFixed(2) + "<br>Carbohydrate: "+ carb.toFixed(2) + "<br>Fat: "+fat.toFixed(2) + "<br>FatTotal Calories for Everyday: "+totalCalories.toFixed(2);
  // console.log(protein.toFixed(2), carb.toFixed(2), fat.toFixed(2), totalCalories.toFixed(2));
