            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Food Categories
                    ...
                    @endif
                  <a href="{{url('/medical-term-create')}}" class="btn btn-primary float-right">ADD</a>
                </h4>
              </div>
              <div class="card-body">
                  ...
                  <table id="dataTable" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $loop->index+1}}</td>
                        <td>{{ $row->term_name}}</td> 
                        <td><a href="{{('/medical-term/'.$row->id)}}" class="btn btn-info">Edit</a></td> 
                        <td>
                          <form action="{{url('/medical-term-delete/'.$row->id)}}" method="POST">
                            {{csrf_field()}}
                            {{method_field('DELETE')}}
